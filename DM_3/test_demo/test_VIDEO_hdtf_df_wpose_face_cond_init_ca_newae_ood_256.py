...
CKPT_DIR = os.path.join(DATASAVE_DIR, 'hdtf_wpose_faceemb_1_256','outofset_paint', name + f'WIN{WIN_WIDTH}','video')
os.makedirs(CKPT_DIR, exist_ok=True)
IMG_DIR = os.path.join(DATASAVE_DIR, 'hdtf_wpose_faceemb_1_256','outofset_paint', name + f'WIN{WIN_WIDTH}','img')
