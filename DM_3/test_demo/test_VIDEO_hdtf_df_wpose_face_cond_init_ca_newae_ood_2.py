...
def main():
    ...
    real_pose_path = f'your/path/DAWN-pytorch/ood_data/ood_test_material/cache/init_pose.npy'
    ref_img_path = 'your/path/DAWN-pytorch/ood_data/ood_test_material/anime_ai_test2.jpeg'# f'/train20/intern/permanent/lmlin2/data/test_source_img/IMG_7459.jpg'
    real_blink_bbox_path = f'your/path/DAWN-pytorch/ood_data/ood_test_material/cache/init_eye_bbox.npy'
