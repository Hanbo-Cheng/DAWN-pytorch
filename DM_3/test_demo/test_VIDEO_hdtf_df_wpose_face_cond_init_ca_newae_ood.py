...
import sys
sys.path.append('/train20/intern/permanent/hbcheng2/AIGC_related/DAWN')
import argparse
...
CKPT_DIR = os.path.join(DATASAVE_DIR, 'hdtf_wpose_faceemb_1','outofset', name + f'WIN{WIN_WIDTH}','video')
os.makedirs(CKPT_DIR, exist_ok=True)
IMG_DIR = os.path.join(DATASAVE_DIR, 'hdtf_wpose_faceemb_1','outofset', name + f'WIN{WIN_WIDTH}','img')
...
def main():
    ...
    # ref_face_id = 'WDA_NancyPelosi1_000' # 'WDA_NancyPelosi1_000' # 'WRA_JohnKasich1_001'
    ...
    real_pose_path = f'your/path/DAWN-pytorch/ood_data/ood_test_material/cache_2/init_pose.npy'
    ref_img_path = 'your/path/DAWN-pytorch/ood_data/ood_test_material/painting_real_test2.jpg'# f'/train20/intern/permanent/lmlin2/data/test_source_img/IMG_7459.jpg'
    real_blink_bbox_path = f'your/path/DAWN-pytorch/ood_data/ood_test_material/cache_2/init_eye_bbox.npy'
