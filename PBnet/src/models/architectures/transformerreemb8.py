...
import math 
from src.models.architectures.transformerdecoder7 import *
...
class Encoder_TRANSFORMERREEMB8(nn.Module):
...
class Decoder_TRANSFORMERREEMB8(nn.Module):
    def __init__(self, modeltype, num_frames, audio_dim=1024, pos_dim=6, eye_dim=2, pose_latent_dim=64,
    ...
    def forward(self, batch):
        ...
        # timequeries = self.q_dropout(timequeries) 
        # # only for ablation / not used in the final model
        # if self.ablation == "time_encoding":
