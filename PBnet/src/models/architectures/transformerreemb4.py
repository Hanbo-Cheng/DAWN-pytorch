...
class Encoder_TRANSFORMERREEMB4(nn.Module):
...
class Decoder_TRANSFORMERREEMB4(nn.Module):
    def __init__(self, modeltype, num_frames, audio_dim=1024, pos_dim=7, pose_latent_dim=64,
    ...
    def forward(self, batch):
        ...
        # timequeries = self.init_temporal_attn(timequeries, pos_bias=time_rel_pos_bias_tgt)
